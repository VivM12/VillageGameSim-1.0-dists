...
define gui.text_color = '#3d2314'  # Dark brown for readability
define gui.interface_text_color = '#3d2314'
define gui.accent_color = '#c4741f'  # Warm orange/brown
define gui.hover_color = '#d4943f'  # Lighter orange on hover
define gui.selected_color = '#8b4513'  # Darker brown when selected
...
define gui.text_color = '#000000'  # Pure black
...
define gui.main_menu_text_xalign = 0.1  # Align buttons to left side
define gui.main_menu_text_yalign = 0.4  # Position vertically
...
define gui.idle_color = '#3d2314'  # Dark brown
...
define gui.choice_button_text_idle_color = '#1a0f08'
